...
class SyncEngine(
    private val mount: com.aicodeeditor.feature.workspace.domain.model.RemoteMount,
    private val connection: com.aicodeeditor.feature.workspace.domain.model.RemoteConnection,
