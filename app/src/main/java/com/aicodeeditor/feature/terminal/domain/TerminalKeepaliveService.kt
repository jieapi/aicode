...
class TerminalKeepaliveService : Service() {
     ...
     * 不应让进程崩溃（设置页的开关仍是开启态，下次前台时由 [com.aicodeeditor.MainActivity] 恢复）。
     */
    private fun ensureForeground() {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentTitle("AI Code Editor")
            .setContentText(text)
            .setOngoing(true)
    ...
    companion object {
        ...
        const val ACTION_START_SESSION = "com.aicodeeditor.action.START_SESSION"
        const val ACTION_STOP_SESSION = "com.aicodeeditor.action.STOP_SESSION"
        const val ACTION_ENABLE_PERSISTENT = "com.aicodeeditor.action.ENABLE_PERSISTENT"
        const val ACTION_DISABLE_PERSISTENT = "com.aicodeeditor.action.DISABLE_PERSISTENT"
